...
DEFAULT_FS_EVENT_PASSWORD="NXClueCon2019!"
DEFAULT_FS_DEFAULT_PASSWORD=$(cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 32 | head -n 1)
DEFAULT_FS_INTERNAL_WS_PORT=7480
DEFAULT_FS_INTERNAL_WSS_PORT=7443
DEFAULT_FS_INTERNAL_SIP_PORT=5060
DEFAULT_FS_INTERNAL_TLS_PORT=5061
DEFAULT_FS_EXTERNAL_SIP_PORT=5080
DEFAULT_FS_EVENT_PORT=18020
...
DEFAULT_FS_GLOBAL_CODEC="G729,PCMA,PCMU"
DEFAULT_FS_OUTBOUND_CODEC="G729,PCMA,PCMU"
DEFAULT_FS_RECORDING_DIR="/data"
